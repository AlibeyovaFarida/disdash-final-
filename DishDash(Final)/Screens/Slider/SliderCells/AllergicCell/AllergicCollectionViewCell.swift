...
class AllergicCollectionViewCell: UICollectionViewCell {
    private let allergicMealList: [AllergicMealItemModel] = [
    ...
    private func setupUI() {
        ...
        allergicCollectionView.snp.makeConstraints { make in
            make.height.equalTo(allergicMealList.count / 3 * 150) // Adjust this as needed
        }
...
extension AllergicCollectionViewCell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configure(allergicMealList[indexPath.row])
        return cell
    }
}
