...
class TrendingRecipesViewController: UIViewController {
    private let viewModel = TrendingRecipesViewModel()
...
extension TrendingRecipesViewController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return viewModel.getTrendingRecipesListCount()
    }
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var recipe = viewModel.trendingRecipesList[indexPath.row]
...
extension TrendingRecipesViewController: UICollectionViewDelegate{
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let vc = TrendingRecipesDetailViewController(productName: viewModel.trendingRecipesList[indexPath.row].name)
        navigationController?.pushViewController(vc, animated: true)
    }
}
